...
var createFragment = function createFragment(HTMLstring) {
  try {
...
var createTodoFragment = function createTodoFragment(string) {
  try {
    var markup = "\n    <div class=\"c-todos__item\">\n      <p>".concat(string, "</p>\n      <i class=\"far fa-times-circle c-todos__remove\"></i>\n    </div> \n  ");
    var docFrag = createFragment(markup);
    return docFrag;
  } catch (error) {
...
var sumbitTodo = function sumbitTodo() {
  try {
    var input = getInput();
    var todoStr = input.value;
    if (!todoStr) return;
    clearInput(input);
...
var attachEvent = function attachEvent() {
  ...
  try {
    ...
    if (type === _constants.EVENT_TYPES.KEYPRESS) {
...
window.addEventListener(_constants.EVENT_TYPES.LOAD, init);
},{"./constants":"js/constants.js"}],"node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
